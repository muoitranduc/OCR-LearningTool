...
namespace MachineLearningOCRTool.Views
{
    public partial class OCRTool : Form
    {
        ...
        private void LoadModel()
        {
            ...
            double[][] thetas = GetModelParamsFromFile();
            int rows = thetas.GetLength(0);
            int columns = thetas[0].GetLength(0);
            double[][] inputNN = new double[rows][];
            double[][] idealNN = new double[rows][];
        ...
        private double[] GetBlobPixels(BlobPanel blob)
        {
            ...
            double[] xs = new double[newImage.Width * newImage.Height + 1];
            //xs[0] = 1;
        ...
        /// </summary>
        private double[][] GetModelParamsFromFile()
        {
